...
* The [Sample processing log](sampleprocessinglog_1.md)provides day-to-day accounts of work on these samples.
* The [SNOTEL visit log](log1.md)for notes on site visits.
* The [field protocol](fieldprotocol.md)describes field methods and samples collected during SNOTEL site visits.
* The [initial processing procedures](sampleprocessing.md)for samples. This links to other procedures.
