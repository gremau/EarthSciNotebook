...
replications in each plot. Each [soil temperature/moisture profile](../hiddencanyon/soilprofiles.md) currently is associated
with 3 inlets. There are thus 9 inlets each in the control and treatment
plots in the [Hidden Canyon snowpack manipulation](../hiddencanyon/snowmeltdesign.md).
...
* See the **protocol** for this [here](exetainer_CO2).
