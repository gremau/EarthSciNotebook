...
More on this module
[here](http://pythonconquerstheuniverse.wordpress.com/category/python-debugger/ "wikilink").
The Python library page is
[here](http://docs.python.org/library/pdb.html "wikilink").
...
the [IPython page](procedures:ipython "wikilink") for more.
