...
* The [Sample processing log](snotelC/snotelC_sampleprocessinglog_1.md)provides day-to-day accounts of work on these samples.
* The [SNOTEL visit log](snotelC/snotelC_log1.md)for notes on site visits.
* The [field protocol](snotelC/snotelC_fieldprotocol.md)describes field methods and samples collected during SNOTEL site visits.
* The [initial processing procedures](snotelC/snotelC_sampleprocessing.md)for samples. This links to other procedures.
