...
[wp&gt;Correlation\_and\_dependence](wp>Correlation_and_dependence "wikilink")).
...
` * `[`John` `Cook's`
`take`](http://www.johndcook.com/blog/2008/11/05/how-to-calculate-pearson-correlation-accurately/ "wikilink")
...
([wp&gt;Coefficient\_of\_determination](wp>Coefficient_of_determination "wikilink")),
...
` * See other notes `[`here`](linear_regression "wikilink")`.`
...
[This
paper](http://journals.ametsoc.org/doi/abs/10.1175/2009JCLI2951.1 "wikilink")
...
` * `[`SE`
`question`](http://stats.stackexchange.com/questions/5750/look-and-you-shall-find-a-correlation "wikilink")
